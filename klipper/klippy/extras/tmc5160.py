...
class TMC5160CurrentHelper:
    def __init__(self, config, mcu_tmc):
        ...
        self.run_current = run_current = config.getfloat('run_current',
                                      above=0., maxval=MAX_CURRENT)
        self.hold_current = hold_current = config.getfloat('hold_current', run_current,
                                       above=0., maxval=MAX_CURRENT)
    ...
    def get_set_current(self):
        return self.run_current,self.hold_current
    def get_current(self):
        # run_current = self._calc_current_from_field("irun")
        # hold_current = self._calc_current_from_field("ihold")
        # return run_current, hold_current, MAX_CURRENT
        return self.run_current,self.hold_current,MAX_CURRENT
...
class TMC5160:
    def __init__(self, config):
        ...
        toolhead = printer.lookup_object('mcu')
        toolhead.add_tmc_motors(current_helper.get_name(),self)
        self.name = "tmc5160 %s"%(current_helper.get_name(),)
