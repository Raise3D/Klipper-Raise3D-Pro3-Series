...
class HomingMove:
    ...
    def homing_move(self, movepos, speed, probe_pos=False,
                    triggered=True, check_triggered=True,axes = 0):
...
class Homing:
    ...
    def home_rails(self, rails, forcepos, movepos):
        ...
        if hi.retract_dist:
            ...
            hmove.homing_move(homepos, hi.second_homing_speed,axes = homing_axes[0])
...
class PrinterHoming:
    ...
    def cmd_G28(self, gcmd):
        ...
        try:
            ...
            # if probe != None and z_rail.check_endstop() == False:
            #     probe.run_probe()
        except self.printer.command_error:
            if self.printer.is_shutdown():
                raise self.printer.command_error(
