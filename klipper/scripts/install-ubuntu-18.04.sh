...
install_packages()
{
    ...
    PKGLIST="virtualenv python2-dev libffi-dev build-essential python-pip"
    ...
    # PKGLIST="${PKGLIST} stm32flash libnewlib-arapm-none-eabi"
    PKGLIST="${PKGLIST} libnewlib-arm-none-eabi"
    PKGLIST="${PKGLIST} gcc-arm-none-eabi binutils-arm-none-eabi libusb-1.0"
    PKGLIST="${PKGLIST} python2-pip-whl python2-setuptools-whl"
